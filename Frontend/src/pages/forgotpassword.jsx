...
export default function ForgotPassword() {
  ...
  const handleSendOtp = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://gramconnect-project.onrender.com/api/auth/send-otp", {
        method: "POST",
  ...
  const handleResetPassword = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://gramconnect-project.onrender.com/api/auth/reset-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
